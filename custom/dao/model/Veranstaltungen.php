<?php
   ...
   * @method string getVeranstaltungsSeoTitel(\int $contentID, \int $languageID)
   ...
   * @method void setVeranstaltungsSeoTitel(\int $contentID, \string $value, \int $languageID)
   ...
   * @property string VeranstaltungsSeoTitel
