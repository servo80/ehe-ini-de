<?php
   ...
   * @method integer getVeranstaltungsbeginn(\int $languageID)
   * @method integer getVeranstaltungsstartdatum2(\int $languageID)
   * @method integer getVeranstaltungsenddatum2(\int $languageID)
   * @method integer getVeranstaltungsbeginn2(\int $languageID)
   ...
   * @method void setVeranstaltungsbeginn(\integer $value, \int $languageID)
   * * @method void setVeranstaltungsstartdatum2(\integer $value, \int $languageID)
   * @method void setVeranstaltungsenddatum2(\integer $value, \int $languageID)
   * @method void setVeranstaltungsbeginn2(\integer $value, \int $languageID)
